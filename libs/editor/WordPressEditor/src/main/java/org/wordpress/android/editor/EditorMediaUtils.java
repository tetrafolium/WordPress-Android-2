...
public class EditorMediaUtils {
  ...
  getAztecPlaceholderDrawableFromResID(Context context,
    ...
    if (drawable instanceof BitmapDrawable) {
      ...
      bitmap = ImageUtils.getScaledBitmapAtLongestSide(
          bitmap, maxImageSizeForVisualEditor);
    } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP &&
               drawable instanceof VectorDrawable) {
      bitmap = Bitmap.createBitmap(maxImageSizeForVisualEditor,
                                   maxImageSizeForVisualEditor,
