...
public class EditorImageMetaData implements Parcelable {
  public static final String ARG_EDITOR_IMAGE_METADATA =
      "editor_image_metadata";

  @SerializedName("align") @Expose private String mAlign;

  @SerializedName("alt") @Expose private String mAlt;

  @SerializedName("attachment_id") @Expose private String mAttachmentId;

  @SerializedName("caption") @Expose private String mCaption;

  @SerializedName("captionClassName") @Expose private String mCaptionClassName;

  @SerializedName("captionId") @Expose private String mCaptionId;

  @SerializedName("classes") @Expose private String mClasses;

  @SerializedName("height") @Expose private String mHeight;

  @SerializedName("linkClassName") @Expose private String mLinkClassName;

  @SerializedName("linkRel") @Expose private String mLinkRel;

  @SerializedName("linkTargetBlank") @Expose private boolean mLinkTargetBlank;

  @SerializedName("linkUrl") @Expose private String mLinkUrl;

  @SerializedName("size") @Expose private String mSize;

  @SerializedName("src") @Expose private String mSrc;

  @SerializedName("title") @Expose private String mTitle;

  @SerializedName("width") @Expose private String mWidth;

  @SerializedName("naturalWidth") @Expose private int mNaturalWidth;

  @SerializedName("naturalHeight") @Expose private int mNaturalHeight;
  ...
  public void setAlign(String align) { this.mAlign = align; }

  public String getAlt() { return mAlt; }

  public void setAlt(String alt) { this.mAlt = alt; }
  ...
  public String getCaptionClassName() { return mCaptionClassName; }

  public void setCaptionClassName(String captionClassName) {
    this.mCaptionClassName = captionClassName;
  }

  public String getCaptionId() { return mCaptionId; }

  public void setCaptionId(String captionId) { this.mCaptionId = captionId; }
  ...
  public int getHeightInt() { return StringUtils.stringToInt(mHeight); }

  public void setHeight(String height) { this.mHeight = height; }

  public String getLinkClassName() { return mLinkClassName; }
  ...
  public void setLinkRel(String linkRel) { this.mLinkRel = linkRel; }

  public boolean isLinkTargetBlank() { return mLinkTargetBlank; }
  ...
  public void setLinkUrl(String linkUrl) { this.mLinkUrl = linkUrl; }
  ...
  public int getWidthInt() { return StringUtils.stringToInt(mWidth); }

  public void setWidth(String width) { this.mWidth = width; }

  public int getLocalId() { return mLocalId; }

  public void setLocalId(int localId) { mLocalId = localId; }

  public boolean isRemoved() { return mIsRemoved; }

  public void markAsRemoved() { mIsRemoved = true; }
