...
public static String getHtmlFromFile(Activity activity, String filename) {
	try {
		...
		AppLog.e(AppLog.T.EDITOR,
		         "Unable to load editor HTML (is the assets symlink working?): " +
		         e.getMessage());
		return null;
	}
}
...
public static String escapeHtml(String html) {
	if (html != null) {
		...
		// Escape invisible line separator (U+2028) and paragraph separator
		// (U+2029) characters
...
public static String decodeHtml(String html) {
	if (html != null) {
		try {
			...
			AppLog.e(AppLog.T.EDITOR,
			         "Unsupported encoding exception while decoding HTML.");
		}
	}
	return html;
}
 ...
 */
public static Set<String> splitDelimitedString(String string,
                                               String delimiter) {
...
/**
 * Splits a delimited string of value pairs (of the form identifier=value)
...
splitValuePairDelimitedString(String string, String delimiter,
...
/**
 * Accepts a set of strings, each string being a key-value pair
 * (<code>id=5</code>, <code>name=content-filed</code>). Returns a map of all
 * the key-value pairs in the set.
 * @param keyValueSet the set of key-value pair strings
 */
public static Map<String, String>
buildMapFromKeyValuePairs(Set<String> keyValueSet) {
	Map<String, String> selectionArgs = new HashMap<>();
	for (String pair : keyValueSet) {
		int delimLoc = pair.indexOf("=");
		if (delimLoc != -1) {
			selectionArgs.put(pair.substring(0, delimLoc),
			                  pair.substring(delimLoc + 1));
		}
	}
...
/**
 * Compares two <code>Sets</code> and returns a <code>Map</code> of elements
 * not contained in both <code>Sets</code>. Elements contained in
 * <code>oldSet</code> but not in <code>newSet</code> will be marked
 * <code>false</code> in the returned map; the converse will be marked
 * <code>true</code>.
 ...
 * @return a <code>Map</code> containing the difference between
 *     <code>oldSet</code> and <code>newSet</code>,
 * and whether the element was added (<code>true</code>) or removed
 * (<code>false</code>) in <code>newSet</code>
 */
public static <E> Map<E, Boolean> getChangeMapFromSets(Set<E> oldSet,
                                                       Set<E> newSet) {
...
/**
 * Checks the Clipboard for text that matches the {@link Patterns#WEB_URL}
 * pattern.
 *
