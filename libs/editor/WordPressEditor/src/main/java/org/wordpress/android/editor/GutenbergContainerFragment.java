...
public class GutenbergContainerFragment extends Fragment {
  ...
  public static GutenbergContainerFragment
  ...
  public boolean hasReceivedAnyContent() { return mHasReceivedAnyContent; }
  ...
  public void attachToContainer(
    ...
    mWPAndroidGlueCode.attachToContainer(
        viewGroup, onMediaLibraryButtonListener, onReattachQueryListener,
        onEditorMountListener, onEditorAutosaveListener,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    boolean isNewPost =
        getArguments() != null && getArguments().getBoolean(ARG_IS_NEW_POST);
    ...
    mWPAndroidGlueCode.onCreateView(
        getContext(), mHtmlModeEnabled, getActivity().getApplication(),
        BuildConfig.DEBUG, BuildConfig.BUILD_GUTENBERG_FROM_SOURCE, isNewPost,
        localeString, translations);

    // clear the content initialization flag since a new ReactRootView has been
    // created;
  ...
  public void mediaFileUploadSucceeded(final int mediaId, final String mediaUrl,
    ...
    mWPAndroidGlueCode.mediaFileUploadSucceeded(mediaId, mediaUrl,
                                                serverMediaId);
  }
