...
public class UtilsTest {
  ...
  public void testDecodeHtml() {
    ...
    // Test normal usage
    assertEquals("http://www.wordpress.com/",
                 decodeHtml("http%3A%2F%2Fwww.wordpress.com%2F"));
  }
  ...
  public void testSplitValuePairDelimitedString() {
    ...
    assertEquals(keyValueSet,
                 splitValuePairDelimitedString(
                     "url=http://www.wordpress.com/~user~title=I'm a link!",
                     "~", identifiers));
    ...
    assertEquals(keyValueSet,
                 splitValuePairDelimitedString("url=http://www.wordpress.com/",
                                               "~", identifiers));
    ...
    assertEquals(keyValueSet,
                 splitValuePairDelimitedString("something=something else", "~",
                                               identifiers));
  }
  ...
  public void testBuildMapFromKeyValuePairs() {
    ...
    // Test multiple '=' (should split at the first `=` and treat the rest of
    ...
    assertEquals(Collections.emptyMap(),
                 buildMapFromKeyValuePairs(keyValueSet));

    // Test empty sets
    assertEquals(Collections.emptyMap(),
                 buildMapFromKeyValuePairs(Collections.<String>emptySet()));
  }
  ...
  public void testGetChangeMapFromSets() {
    ...
    assertEquals(
        ...
        getChangeMapFromSets(Collections.emptySet(), Collections.emptySet()));
  }
