...
public void testTypingInOpeningTag() {
	...
	String[] previousTextCases =
		new String[] {"", "plain text", "<i>",
...
public void testTypingInClosingTag() {
	// Test with several different cases of pre-existing text
	String[] previousTextCases = new String[] {
		"<b>stuff", "plain text <b>stuff", "<i><b>stuff",
...
public void testTypingInTagWithSurroundingTags() {
	...
	mContent =
		new SpannableStringBuilder("some <del>text</del> < <b>bold text</b>");
	...
	// -- Test typing in the tag name
	mContent =
		new SpannableStringBuilder("some <del>text</del> <i <b>bold text</b>");
...
public void testTypingInLoneClosingSymbol() {
	...
	// The span in this case will be applied from the start of the previous tag
	// to the end of the next tag
...
public void testDeletingPartsOfTag() {
	...
	// Deleted characters are removed from the string between
	// beforeTextChanged() and onTextChanged()
...
public void testPasteTagPair() {
	// -- Test pasting in a set of opening and closing tags at the end of the
	// document
