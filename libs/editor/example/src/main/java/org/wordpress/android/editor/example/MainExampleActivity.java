...
protected void onCreate(Bundle savedInstanceState) {
	...
	newEditorPost1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
			        Intent intent =
					new Intent(MainExampleActivity.this, EditorExampleActivity.class);
			        Bundle bundle = new Bundle();
			        bundle.putString(EditorExampleActivity.TITLE_PARAM,
			                         getString(R.string.example_post_visual_title));
			        bundle.putString(
					EditorExampleActivity.CONTENT_PARAM,
					Utils.getHtmlFromFile(mActivity, "example/example-content.html"));
			        ...
			        bundle.putInt(EditorExampleActivity.EDITOR_PARAM,
			                      EditorExampleActivity.USE_NEW_EDITOR);
			        intent.putExtras(bundle);
			        startActivity(intent);
			}
		});

	Button newEditorPostEmpty =
		(Button)findViewById(R.id.aztec_editor_post_empty);
	...
	Button legacyEditorPost1Local =
		(Button)findViewById(R.id.gutenberg_editor_post_1_local);
	legacyEditorPost1Local.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
			        ...
			        Bundle bundle = new Bundle();
			        bundle.putString(EditorExampleActivity.TITLE_PARAM,
			                         getString(R.string.example_post_1_title));
			        bundle.putString(EditorExampleActivity.CONTENT_PARAM,
			                         getString(R.string.example_post_1_content));
			        bundle.putInt(EditorExampleActivity.EDITOR_PARAM,
			                      EditorExampleActivity.USE_LEGACY_EDITOR);
	...
	Button legacyEditorPost1Remote =
		(Button)findViewById(R.id.gutenberg_editor_post_1_remote);
