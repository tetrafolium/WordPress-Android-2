 ...
 *
 * @return true if permissions are already granted, else request them and
 *     return false.
 */
 ...
 *     return false.
 */
private static boolean checkAndRequestPermissions(Fragment fragment,
                                                  int requestCode,
                                                  String[] permissionList) {
	List<String> toRequest = new ArrayList<>();
	for (String permission : permissionList) {
...
checkAndRequestCameraAndStoragePermissions(Fragment fragment,
                                           int requestCode) {
...
public static boolean
checkAndRequestCameraAndStoragePermissions(Activity activity,
                                           int requestCode) {
	return checkAndRequestPermissions(
