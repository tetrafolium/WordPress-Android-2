...
public class MediaGallery implements Serializable {
  ...
  public MediaGallery(boolean isRandom, String type, int numColumns,
                      ArrayList<Long> ids) {
    mIsRandom = isRandom;
    mType = type;
  ...
  public boolean isRandom() { return mIsRandom; }

  public void setRandom(boolean isRandom) { this.mIsRandom = isRandom; }
  ...
  public void setNumColumns(int numColumns) { this.mNumColumns = numColumns; }

  public ArrayList<Long> getIds() { return mIds; }
  ...
  public void setIds(ArrayList<Long> ids) { this.mIds = ids; }

  /**
   * An id to uniquely identify a media gallery object, so that the same object
   * can be edited in the post editor
   */
