...
public class EditTextUtils {
  private EditTextUtils() { throw new AssertionError(); }
   ...
   *
   * @deprecated Use {@link ActivityUtils#hideKeyboard(Activity)} or {@link
   *     ActivityUtils#hideKeyboardForced(View)}
   * instead.
   */
  // TODO: Replace instances with ActivityUtils#showKeyboard(Activity) or
  // ActivityUtils#showKeyboardForced(View) to consolidate similar methods and
  // favor library version.
  @Deprecated
   ...
   */
  // TODO: Replace instances with ActivityUtils#showKeyboard(View) to
