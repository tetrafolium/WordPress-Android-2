...
public class WPImageSpan extends ImageSpan implements Parcelable {
  ...
  protected WPImageSpan() { super((Bitmap)null); }
  ...
  public int getEndPosition() {
    return mEndPosition < getStartPosition() ? getStartPosition()
                                             : mEndPosition;
  }

  public MediaFile getMediaFile() { return mMediaFile; }

  public void setMediaFile(MediaFile mediaFile) { this.mMediaFile = mediaFile; }

  public void setImageSource(Uri imageSource) {
    this.mImageSource = imageSource;
  }

  public Uri getImageSource() { return mImageSource; }

  public boolean isNetworkImageLoaded() { return mNetworkImageLoaded; }
  ...
  public void writeToParcel(Parcel parcel, int i) {
    parcel.writeBooleanArray(
        new boolean[] {mNetworkImageLoaded, mMediaFile.isVideo()});
