...
public class AutoResizeTextView extends AppCompatTextView {
   ...
   * @return
   */
  public boolean getAddEllipsis() { return mAddEllipsis; }
  ...
  public void resizeText() {
    ...
    int widthLimit = getWidth() - ViewCompat.getPaddingStart(this) -
  ...
  public void resizeText(int width, int height) {
    ...
    float targetTextSize =
        mMaxTextSize > 0 ? Math.min(mTextSize, mMaxTextSize) : mTextSize;
    ...
    if (mAddEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
      ...
      // Draw using a static layout
      StaticLayout layout =
          new StaticLayout(text, paint, width, Layout.Alignment.ALIGN_NORMAL,
