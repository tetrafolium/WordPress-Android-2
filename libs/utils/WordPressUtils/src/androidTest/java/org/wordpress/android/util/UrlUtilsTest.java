...
public void testAppendUrlParameters1() {
	...
	if (!url.equals("http://wp.com/test?h=300&w=200") &&
	    !url.equals("http://wp.com/test?w=200&h=300")) {
...
public void testAppendUrlParameters2() {
	...
	if (!url.equals("/relative/test?h=300&w=200") &&
	    !url.equals("/relative/test?w=200&h=300")) {
		assertTrue("failed test on url: " + url, false);
	}
}
