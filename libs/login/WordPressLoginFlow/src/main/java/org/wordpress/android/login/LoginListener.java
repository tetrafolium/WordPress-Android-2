...
void loginViaSocialAccount(String email, String idToken, String service,
...
void needs2faSocialConnect(String email, String password, String idToken,
                           String service);
...
void gotWpcomSiteInfo(String siteAddress, String siteName,
                      String siteIconUrl);
void gotConnectedSiteInfo(@NonNull String siteAddress,
                          @Nullable String redirectUrl, boolean hasJetpack);
void gotXmlRpcEndpoint(String inputSiteAddress, String endpointAddress);
void handleSslCertificateError(MemorizingTrustManager memorizingTrustManager,
                               SelfSignedSSLCallback callback);
...
void saveCredentialsInSmartLock(@Nullable String username,
...
// TODO This should have a more generic name, it more or less means any kind
// of login was finished
