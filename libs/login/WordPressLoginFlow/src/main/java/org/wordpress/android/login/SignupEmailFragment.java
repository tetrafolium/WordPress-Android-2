...
public class SignupEmailFragment extends LoginBaseFormFragment<LoginListener>
  ...
  private static final String LOG_TAG =
      SignupEmailFragment.class.getSimpleName();
  ...
  protected void onHelp() {
    if (mLoginListener != null) {
      mLoginListener.helpSignupEmailScreen(
  ...
  private void showErrorEmail(String message) { mEmailInput.setError(message); }
  ...
  public void onAvailabilityChecked(OnAvailabilityChecked event) {
    if (mRequestedEmail != null &&
      ...
      if (event.isError()) {
        AppLog.e(T.API, "OnAvailabilityChecked error: " + event.error.type +
                            " - " + event.error.message);
        ...
        case EMAIL:
          ...
          if (mLoginListener != null) {
            if (event.isAvailable) {
              ...
              // Kill connections with FluxC and this fragment since the flow is
              // changing to login.
          ...
          break;
        default:
          AppLog.e(T.API, "OnAvailabilityChecked unhandled event: " +
                              event.error.type);
          break;
        }
      }
