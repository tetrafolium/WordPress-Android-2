...
public interface LoginAnalyticsListener {
  ...
  void trackLoginFailed(String errorContext, String errorType,
  ...
  void trackSocialFailure(String errorContext, String errorType,
                          String errorDescription);
  ...
  void trackConnectedSiteInfoFailed(String url, String errorContext,
