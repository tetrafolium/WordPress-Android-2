...
public enum Stat {
	...
	ENHANCED_SITE_CREATION_VERTICALS_VIEWED,
	ENHANCED_SITE_CREATION_VERTICALS_SELECTED,
	ENHANCED_SITE_CREATION_VERTICALS_SKIPPED,
	ENHANCED_SITE_CREATION_BASIC_INFORMATION_VIEWED,
	ENHANCED_SITE_CREATION_BASIC_INFORMATION_COMPLETED,
	ENHANCED_SITE_CREATION_BASIC_INFORMATION_SKIPPED,
...
public static void init(Context context) {
	...
	boolean hasUserOptedOut =
		!prefs.getBoolean("wp_pref_send_usage_stats", true);
...
/**
 * A convenience method for logging an error event with some additional meta
 * data.
 * @param stat The stat to track.
 * @param errorContext A string providing additional context (if any) about
 *     the error.
 * @param errorType The type of error.
 * @param errorDescription The error text or other description.
 */
public static void track(Stat stat, String errorContext, String errorType,
