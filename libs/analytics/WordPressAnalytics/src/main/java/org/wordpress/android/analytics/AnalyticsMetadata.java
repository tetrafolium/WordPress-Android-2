...
public class AnalyticsMetadata {
  ...
  public int getNumBlogs() { return mNumBlogs; }

  public void setNumBlogs(int numBlogs) { this.mNumBlogs = numBlogs; }
  ...
  public boolean isGutenbergEnabled() { return mIsGutenbergEnabled; }
