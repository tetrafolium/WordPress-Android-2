...
public abstract class Tracker {
  ...
  private String mAnonID =
      null; // do not access this variable directly. Use methods.
  ...
  String generateNewAnonID() {
    ...
    AppLog.d(AppLog.T.STATS, "New anonID generated in " +
  ...
  String getWordPressComUserName() { return mWpcomUserName; }

  void setWordPressComUserName(String userName) { mWpcomUserName = userName; }
