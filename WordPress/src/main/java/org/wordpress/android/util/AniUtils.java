...
public class AniUtils {
  ...
  public interface AnimationEndListener { void onAnimationEnd(); }

  private AniUtils() { throw new AssertionError(); }
  ...
  public static void startAnimation(View target, int aniResId, int duration) {
    ...
    Animation animation =
        AnimationUtils.loadAnimation(target.getContext(), aniResId);
    if (animation != null) {
  ...
  public static void showFab(final View view, final boolean show) {
    ...
    int fabHeight =
        context.getResources().getDimensionPixelSize(R.dimen.design_fab_size);
    int fabMargin =
        context.getResources().getDimensionPixelSize(R.dimen.fab_margin);
    ...
    anim.setDuration(show ? Duration.LONG.toMillis(context)
                          : Duration.SHORT.toMillis(context));
  ...
  private static ObjectAnimator getFadeInAnim(final View target,
                                              Duration duration) {
    ObjectAnimator fadeIn =
        ObjectAnimator.ofFloat(target, View.ALPHA, 0.0f, 1.0f);
  ...
  private static ObjectAnimator getFadeOutAnim(final View target,
                                               Duration duration,
                                               final int endVisibility) {
    ObjectAnimator fadeOut =
        ObjectAnimator.ofFloat(target, View.ALPHA, 1.0f, 0.0f);
  ...
  public static void scale(final View target, float scaleStart, float scaleEnd,
                           Duration duration) {
    if (target == null || duration == null) {
      return;
    }
  ...
  public static void scaleOut(final View target, final int endVisibility,
                              Duration duration,
