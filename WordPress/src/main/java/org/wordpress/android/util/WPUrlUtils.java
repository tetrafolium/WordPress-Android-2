...
public static boolean isWordPressCom(String url) {
	return UrlUtils.getHost(url).endsWith(".wordpress.com") ||
	       UrlUtils.getHost(url).equals("wordpress.com");
}
...
public static boolean isWordPressCom(URL url) {
	...
	return url.getHost().endsWith(".wordpress.com") ||
	       url.getHost().equals("wordpress.com");
}
...
public static boolean isWordPressCom(URI uri) {
	...
	return uri.getHost().endsWith(".wordpress.com") ||
	       uri.getHost().equals("wordpress.com");
}
...
public static boolean isGravatar(URL url) {
	...
	return url.getHost().equals("gravatar.com") ||
	       url.getHost().endsWith(".gravatar.com");
}

public static String buildTermsOfServiceUrl(Context context) {
	return Constants.URL_TOS +
	       "?locale=" + LanguageUtils.getPatchedCurrentDeviceLanguage(context);
}
}
