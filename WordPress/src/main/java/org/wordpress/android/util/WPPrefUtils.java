...
public class WPPrefUtils {
  /**
   * Gets a preference and sets the {@link
   * android.preference.Preference.OnPreferenceChangeListener}.
   */
  public static Preference
  getPrefAndSetClickListener(PreferenceFragment prefFrag, int id,
   ...
   */
  public static Preference
  getPrefAndSetChangeListener(PreferenceFragment prefFrag, int id,
  ...
  /**
   * Removes a {@link Preference} from the {@link PreferenceCategory} with the
   * given key.
   */
  public static void removePreference(PreferenceFragment prefFrag,
                                      int parentKey, int prefKey) {
    String parentName = prefFrag.getString(parentKey);
    String prefName = prefFrag.getString(prefKey);
    PreferenceGroup parent =
        (PreferenceGroup)prefFrag.findPreference(parentName);
  ...
  /**
   * Styles a {@link TextView} to display a large title against a dark
   * background.
   */
  public static void layoutAsLightTitle(TextView view) {
    int size =
        view.getResources().getDimensionPixelSize(R.dimen.text_sz_extra_large);
    setTextViewAttributes(view, size, android.R.color.white);
  }

  /**
   * Styles a {@link TextView} to display a large title against a light
   * background.
   */
  public static void layoutAsDarkTitle(TextView view) {
    ...
    setTextViewAttributes(view, size,
                          ContextExtensionsKt.getColorResIdFromAttribute(
                              view.getContext(), R.attr.wpColorText));
  }

  /**
   * Styles a {@link TextView} to display medium sized text as a header with
   * sub-elements.
   */
  public static void layoutAsSubhead(TextView view) {
    int color = view.isEnabled()
                    ? ContextExtensionsKt.getColorResIdFromAttribute(
                          view.getContext(), R.attr.wpColorText)
                    : R.color.neutral_20;
  ...
  public static void layoutAsBody1(TextView view) {
    ...
    int size =
        view.getResources().getDimensionPixelSize(R.dimen.text_sz_medium);
    setTextViewAttributes(view, size, color);
  }
  ...
  public static void layoutAsInput(EditText view) {
    ...
    view.setTextColor(ContextExtensionsKt.getColorFromAttribute(
        view.getContext(), R.attr.wpColorText));
    view.setSingleLine(true);
  }

  /**
   * Styles a {@link TextView} to display selected numbers in a {@link
  ...
  /**
   * Styles a {@link TextView} to display non-selected numbers in a {@link
   * android.widget.NumberPicker}.
   */
  ...
  public static void setTextViewAttributes(TextView textView, int size,
                                           int colorRes) {
