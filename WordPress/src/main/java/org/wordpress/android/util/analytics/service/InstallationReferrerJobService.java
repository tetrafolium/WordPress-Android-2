 ...
 * This could be done on the app's main activity but, as we are going to trigger
 * this data gathering from a BroadcastReceiver, we need a Service / JobService
 * to keep it alive while this happens, even if it needs to happen only once.
