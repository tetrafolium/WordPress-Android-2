...
public class PublicizeService {
  ...
  public String getId() { return StringUtils.notNullStr(mId); }

  public void setId(String id) { mId = StringUtils.notNullStr(id); }

  public String getLabel() { return StringUtils.notNullStr(mLabel); }

  public void setLabel(String label) { mLabel = StringUtils.notNullStr(label); }
  ...
  public String getGenericon() { return StringUtils.notNullStr(mGenericon); }

  public void setGenericon(String genericon) {
    mGenericon = StringUtils.notNullStr(genericon);
  }

  public String getIconUrl() { return StringUtils.notNullStr(mIconUrl); }

  public void setIconUrl(String url) { mIconUrl = StringUtils.notNullStr(url); }

  public String getConnectUrl() { return StringUtils.notNullStr(mConnectUrl); }

  public void setConnectUrl(String url) {
    mConnectUrl = StringUtils.notNullStr(url);
  }

  public boolean isJetpackSupported() { return mIsJetpackSupported; }
  ...
  public boolean isExternalUsersOnly() { return mIsExternalUsersOnly; }
