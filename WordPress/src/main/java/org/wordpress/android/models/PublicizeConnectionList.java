...
public class PublicizeConnectionList extends ArrayList<PublicizeConnection> {
  ...
  public PublicizeConnectionList
  getServiceConnectionsForUser(long userId, String serviceId) {
  ...
  public boolean isServiceConnectedForUser(long userId,
  ...
  public static PublicizeConnectionList fromJson(JSONObject json) {
    ...
    for (int i = 0; i < jsonConnectionList.length(); i++) {
      PublicizeConnection connection =
          PublicizeConnection.fromJson(jsonConnectionList.optJSONObject(i));
