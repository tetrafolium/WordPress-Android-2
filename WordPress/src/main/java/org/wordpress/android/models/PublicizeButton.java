...
public class PublicizeButton {
  ...
  public void setShortName(String shortName) { this.mShortName = shortName; }

  public boolean isCustom() { return mIsCustom; }

  public void setCustom(boolean custom) { mIsCustom = custom; }
  ...
  public String getGenericon() { return mGenericon; }

  public void setGenericon(String genericon) { this.mGenericon = genericon; }
}
