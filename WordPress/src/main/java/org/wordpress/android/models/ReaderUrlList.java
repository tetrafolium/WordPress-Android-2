...
/**
 * URLs are normalized before being added and during comparison to ensure better
 * comparison of URLs that may be different strings but point to the same URL
 */
