...
public class ReaderUser {
  ...
  public static ReaderUser fromJson(JSONObject json) {
    ...
    user.mUrl = JSONUtils.getString(
        json, "URL"); // <-- this isn't necessarily a wp blog
  ...
  public String getProfileUrl() { return StringUtils.notNullStr(mProfileUrl); }
  ...
  public boolean hasBlogId() { return (blogId != 0); }
