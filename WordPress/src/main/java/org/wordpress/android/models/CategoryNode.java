...
public class CategoryNode {
  ...
  private int mLevel;
  private SortedMap<String, CategoryNode> mChildren =
  ...
  public SortedMap<String, CategoryNode> getChildren() { return mChildren; }
  ...
  public void setParentId(int parentId) { this.mParentId = parentId; }

  public int getLevel() { return mLevel; }

  public static CategoryNode
  createCategoryTreeFromList(List<TermModel> categories) {
    ...
    for (TermModel category : categories) {
      ...
      CategoryNode node =
          new CategoryNode(categoryId, parentId, category.getName());
  ...
  private static void
  preOrderTreeTraversal(CategoryNode node, int level,
  ...
  public static ArrayList<CategoryNode>
  getSortedListOfCategoriesFromRoot(CategoryNode node) {
