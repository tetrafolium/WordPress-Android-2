...
public class ReaderRecommendedBlog {
  ...
  public static ReaderRecommendedBlog fromJson(JSONObject json) {
    ...
    // the "url" field points to an API endpoint, "blog_domain" contains the
    // actual url
  ...
  public void setTitle(String title) { mTitle = StringUtils.notNullStr(title); }

  public String getReason() { return StringUtils.notNullStr(mReason); }
  ...
  protected boolean isSameAs(ReaderRecommendedBlog blog) {
    ...
    return (blog.blogId == this.blogId && blog.score == this.score &&
