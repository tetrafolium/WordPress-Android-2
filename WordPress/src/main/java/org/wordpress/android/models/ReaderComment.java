...
public class ReaderComment {
  ...
  // not stored in db - denotes the indentation level when displaying this
  // comment
  ...
  public static ReaderComment fromJson(JSONObject json, long blogId) {
    ...
    // like info is found under meta/data/likes when meta=likes query param is
    // used
  ...
  public String getAuthorUrl() { return StringUtils.notNullStr(mAuthorUrl); }
  ...
  public String getPublished() { return StringUtils.notNullStr(mPublished); }

  public void setPublished(String published) {
    this.mPublished = StringUtils.notNullStr(published);
  }

  public boolean hasAuthorUrl() { return !TextUtils.isEmpty(mAuthorUrl); }

  public boolean hasAuthorBlogId() { return (authorBlogId != 0); }

  public boolean hasAuthorAvatar() { return !TextUtils.isEmpty(mAuthorAvatar); }
  ...
  public boolean equals(Object other) {
    ...
    return commentId == otherComment.commentId &&
        blogId == otherComment.blogId && postId == otherComment.postId &&
