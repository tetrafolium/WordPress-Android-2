 ...
 */
public class ReaderSiteSearchAdapter
  ...
  private void checkLoadMore(int position) {
    if (mCanLoadMore && !mIsLoadingMore && position >= getItemCount() - 1 &&
        getItemCount() >=
  ...
  public boolean isEmpty() { return mSites.size() == 0; }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                    int viewType) {
    ReaderSiteSearchResultView view =
        new ReaderSiteSearchResultView(parent.getContext());
  ...
  private void setSiteFollowed(@NonNull ReaderSiteModel site,
                               boolean isFollowed) {
