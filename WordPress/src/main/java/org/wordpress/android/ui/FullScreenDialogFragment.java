...
public class FullScreenDialogFragment extends DialogFragment {
  ...
  public static final String TAG =
      FullScreenDialogFragment.class.getSimpleName();
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    ViewGroup view = (ViewGroup)inflater.inflate(
        R.layout.full_screen_dialog_fragment, container, false);
    initToolbar(view);
  ...
  /**
   * Hide {@link androidx.appcompat.app.AppCompatActivity} bar when showing
   * fullscreen dialog.
   */
  ...
  private void initToolbar(View view) {
    ...
    mToolbar.setSubtitleTextAppearance(view.getContext(),
                                       R.style.Toolbar_Subtitle);
    mToolbar.setBackgroundColor(getResources().getColor(mToolbarColor));
    mToolbar.setNavigationIcon(ContextCompat.getDrawable(
        view.getContext(), R.drawable.ic_close_white_24dp));
  ...
  protected void onConfirmClicked() {
    boolean isConsumed =
        ((FullScreenDialogContent)mFragment).onConfirmClicked(mController);
  ...
  protected void onDismissClicked() {
    boolean isConsumed =
        ((FullScreenDialogContent)mFragment).onDismissClicked(mController);
   ...
   *
   * @param listener {@link OnDismissListener} interface to call on dismiss
   *     click
   */
    ...
    if (value.type >= TypedValue.TYPE_FIRST_COLOR_INT &&
      ...
      try {
        Drawable drawable = ResourcesCompat.getDrawable(
            getActivity().getResources(), value.resourceId,
  ...
  /**
   * Show {@link androidx.appcompat.app.AppCompatActivity} bar when hiding
   * fullscreen dialog.
   */
