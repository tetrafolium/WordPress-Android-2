...
public class ReaderSiteSearchResultView extends LinearLayout {
  ...
  public ReaderSiteSearchResultView(Context context) { this(context, null); }
  ...
  public void setSite(@NonNull ReaderSiteModel site,
                      @NonNull OnSiteFollowedListener followListener) {
    mSite = site;
    ...
    ImageManager.getInstance().load(imgBlavatar, ImageType.BLAVATAR,
                                    StringUtils.notNullStr(site.getIconUrl()));
  ...
  private void toggleFollowStatus() {
    ...
    boolean result = ReaderBlogActions.followFeedById(
        mSite.getFeedId(), isAskingToFollow, listener);
    if (result) {
