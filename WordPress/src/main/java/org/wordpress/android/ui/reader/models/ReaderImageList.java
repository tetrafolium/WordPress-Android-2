...
public class ReaderImageList extends ArrayList<String> {
  ...
  public ReaderImageList(boolean isPrivate) { mIsPrivate = isPrivate; }

  // image urls are always added normalized and without query params for easier
  // matching, and to ensure there are no hard-coded sizes in the query
