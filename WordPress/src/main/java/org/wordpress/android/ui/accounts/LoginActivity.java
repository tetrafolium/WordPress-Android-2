...
public class LoginActivity extends AppCompatActivity
    implements ConnectionCallbacks, OnConnectionFailedListener, Callback,
               LoginListener, GoogleListener, LoginPrologueListener,
               SignupSheetListener, HasSupportFragmentInjector,
  ...
  private static final String KEY_SIGNUP_SHEET_DISPLAYED =
      "KEY_SIGNUP_SHEET_DISPLAYED";
  private static final String KEY_SMARTLOCK_HELPER_STATE =
      "KEY_SMARTLOCK_HELPER_STATE";

  private static final String FORGOT_PASSWORD_URL_SUFFIX =
      "wp-login.php?action=lostpassword";

  private static final String GOOGLE_ERROR_DIALOG_TAG =
      "google_error_dialog_tag";
  ...
  private SmartLockHelperState mSmartLockHelperState =
      SmartLockHelperState.NOT_TRIGGERED;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      case SELFHOSTED_ONLY:
        showFragment(new LoginSiteAddressFragment(),
                     LoginSiteAddressFragment.TAG);
        break;
      case JETPACK_STATS:
      ...
      mSignupSheetDisplayed =
          savedInstanceState.getBoolean(KEY_SIGNUP_SHEET_DISPLAYED);
  ...
  public void onSaveInstanceState(Bundle outState) {
    ...
    outState.putString(KEY_SMARTLOCK_HELPER_STATE,
                       mSmartLockHelperState.name());
  }
  ...
  private void loggedInAndFinish(ArrayList<Integer> oldSitesIds,
    ...
    case SHARE_INTENT:
    case SELFHOSTED_ONLY:
      // We are comparing list of site ID's before self-hosted site was added
      // and after, trying to find a newly added self-hosted site's ID, so we
      // can select it
      ...
      if (newSitesIds.size() > 0) {
        ...
        ToastUtils.showToast(this,
                             R.string.site_picker_failed_selecting_added_site);
        setResult(Activity.RESULT_OK);
      }

      // skip the epilogue when only added a self-hosted site or sharing to
      // WordPress
      finish();
      break;
    }
  ...
  protected void onActivityResult(int requestCode, int resultCode,
                                  Intent data) {
    AppLog.d(T.MAIN,
             "LoginActivity: onActivity Result - requestCode" + requestCode);
    super.onActivityResult(requestCode, resultCode, data);

    switch (requestCode) {
    case RequestCodes.SHOW_LOGIN_EPILOGUE_AND_RETURN:
    case RequestCodes.SHOW_SIGNUP_EPILOGUE_AND_RETURN:
      // we showed the epilogue screen as informational and sites got loaded so,
      // just return to login caller now
      setResult(RESULT_OK);
      finish();
      break;
  ...
  private void jumpToUsernamePassword(String username, String password) {
    LoginUsernamePasswordFragment loginUsernamePasswordFragment =
        LoginUsernamePasswordFragment.newInstance(
            ...
            "https://s0.wp.com/i/webclip.png", username, password, true);
    slideInFragment(loginUsernamePasswordFragment, true,
  ...
  /**
   * @param triggerFillInOnConnect set to true, if you want to show an account
   *     chooser dialog when the user has
   *                               stored their credentials in the past. Set to
   * false, if you just want to initialize SmartLock eg. when you want to use it
   * just to save users credentials.
   */
  ...
  private void startLogin() {
    ...
    if (getLoginPrologueFragment() == null) {
      // prologue fragment is not shown so, the email screen will be the initial
      // screen on the fragment container
      ...
      // prologue fragment is shown so, slide in the email screen (and add to
      // history)
  ...
  public void onSignupSheetTermsOfServiceClicked() {
    AnalyticsTracker.track(
        AnalyticsTracker.Stat.SIGNUP_TERMS_OF_SERVICE_TAPPED);
    ActivityLauncher.openUrlExternal(this,
                                     WPUrlUtils.buildTermsOfServiceUrl(this));
  }
  ...
  public void newUserCreatedButErrored(String email, String password) {
    LoginEmailPasswordFragment loginEmailPasswordFragment =
        LoginEmailPasswordFragment.newInstance(email, password, null, null,
                                               false);
    slideInFragment(loginEmailPasswordFragment, false,
                    LoginEmailPasswordFragment.TAG);
  }
  ...
  public void gotWpcomEmail(String email) {
    ...
    if (getLoginMode() != LoginMode.WPCOM_LOGIN_DEEPLINK &&
        getLoginMode() != LoginMode.SHARE_INTENT) {
      LoginMagicLinkRequestFragment loginMagicLinkRequestFragment =
          LoginMagicLinkRequestFragment.newInstance(
              email, AuthEmailPayloadScheme.WORDPRESS, mIsJetpackConnect,
              mJetpackConnectSource != null ? mJetpackConnectSource.toString()
                                            : null);
      slideInFragment(loginMagicLinkRequestFragment, true,
                      LoginMagicLinkRequestFragment.TAG);
    } else {
      LoginEmailPasswordFragment loginEmailPasswordFragment =
          LoginEmailPasswordFragment.newInstance(email, null, null, null,
                                                 false);
      slideInFragment(loginEmailPasswordFragment, true,
                      LoginEmailPasswordFragment.TAG);
    }
  }
  ...
  public void loginViaSiteAddress() {
    LoginSiteAddressFragment loginSiteAddressFragment =
        new LoginSiteAddressFragment();
    slideInFragment(loginSiteAddressFragment, true,
                    LoginSiteAddressFragment.TAG);
  }

  @Override
  public void loginViaSocialAccount(String email, String idToken,
                                    String service,
                                    boolean isPasswordRequired) {
    dismissSignupSheet();
    LoginEmailPasswordFragment loginEmailPasswordFragment =
        LoginEmailPasswordFragment.newInstance(email, null, idToken, service,
                                               isPasswordRequired);
    slideInFragment(loginEmailPasswordFragment, true,
                    LoginEmailPasswordFragment.TAG);
  }
  ...
  public void showMagicLinkSentScreen(String email) {
    ...
    slideInFragment(loginMagicLinkSentFragment, true,
                    LoginMagicLinkSentFragment.TAG);
  }

  @Override
  public void showSignupMagicLink(String email) {
    SignupMagicLinkFragment signupMagicLinkFragment =
        SignupMagicLinkFragment.newInstance(
            email, mIsJetpackConnect,
            mJetpackConnectSource != null ? mJetpackConnectSource.toString()
                                          : null);
  ...
  public void needs2fa(String email, String password) {
    Login2FaFragment login2FaFragment =
        Login2FaFragment.newInstance(email, password);
    slideInFragment(login2FaFragment, true, Login2FaFragment.TAG);
  }

  @Override
  public void needs2faSocial(String email, String userId,
                             String nonceAuthenticator, String nonceBackup,
                             String nonceSms) {
    dismissSignupSheet();
    mLoginAnalyticsListener.trackLoginSocial2faNeeded();
    Login2FaFragment login2FaFragment = Login2FaFragment.newInstanceSocial(
        email, userId, nonceAuthenticator, nonceBackup, nonceSms);
    slideInFragment(login2FaFragment, true, Login2FaFragment.TAG);
  }

  @Override
  public void needs2faSocialConnect(String email, String password,
                                    String idToken, String service) {
    mLoginAnalyticsListener.trackLoginSocial2faNeeded();
    Login2FaFragment login2FaFragment =
        Login2FaFragment.newInstanceSocialConnect(email, password, idToken,
                                                  service);
    slideInFragment(login2FaFragment, true, Login2FaFragment.TAG);
  }
  ...
  public void alreadyLoggedInWpcom(ArrayList<Integer> oldSitesIds) {
    ToastUtils.showToast(this, R.string.already_logged_in_wpcom,
                         ToastUtils.Duration.LONG);
    loggedInAndFinish(oldSitesIds, false);
  }

  public void gotWpcomSiteInfo(String siteAddress, String siteName,
                               String siteIconUrl) {
    LoginUsernamePasswordFragment loginUsernamePasswordFragment =
        LoginUsernamePasswordFragment.newInstance(
  ...
  @Override
  public void gotXmlRpcEndpoint(String inputSiteAddress,
  ...
  @Override
  public void
  handleSslCertificateError(MemorizingTrustManager memorizingTrustManager,
                            final SelfSignedSSLCallback callback) {
    SelfSignedSSLUtils.showSSLWarningDialog(this, memorizingTrustManager,
                                            new SelfSignedSSLUtils.Callback() {
                                              @Override
  ...
  private void viewHelpAndSupport(Origin origin) {
    List<String> extraSupportTags =
        getLoginMode() == LoginMode.JETPACK_STATS
            ? Collections.singletonList(ZendeskExtraTags.connectingJetpack)
            : null;
  ...
  public void startPostLoginServices() {
    // Get reader tags so they're available as soon as the Reader is accessed -
    // done for both wp.com and self-hosted (self-hosted = "logged out" reader)
    // - note that this uses the application context since the activity is
    // finished immediately below
    ReaderUpdateServiceStarter.startService(
        getApplicationContext(), EnumSet.of(ReaderUpdateLogic.UpdateTask.TAGS));
  ...
  @Override
  public void helpUsernamePassword(String url, String username,
                                   boolean isWpcom) {
  ...
  @Override
  public void saveCredentialsInSmartLock(@Nullable final String username,
                                         @Nullable final String password,
                                         @NonNull final String displayName,
                                         @Nullable final Uri profilePicture) {
    if (getLoginMode() == LoginMode.SELFHOSTED_ONLY) {
      // bail if we are on the selfhosted flow since we haven't initialized
      // SmartLock-for-Passwords for it. Otherwise, logging in to WPCOM via the
      // site-picker flow (for example) results in a crash. See
      // https://github.com/wordpress-mobile/WordPress-Android/issues/7182#issuecomment-362791364
      // There might be more circumstances that lead to this crash though. Not
      // all crash reports seem to originate from the site-picker.
      return;
    }

    if (mSmartLockHelper == null) {
      // log some data to help us debug
      // https://github.com/wordpress-mobile/WordPress-Android/issues/7182
      final String loginModeStr =
          "LoginMode: " +
          (getLoginMode() != null ? getLoginMode().name() : "null");
      AppLog.w(AppLog.T.NUX,
               "Internal inconsistency error! mSmartLockHelper found null!" +
                   loginModeStr);
      CrashLoggingUtils.logException(
          new RuntimeException(
              "Internal inconsistency error! mSmartLockHelper found null!"),
          AppLog.T.NUX, loginModeStr);
    ...
    mSmartLockHelper.saveCredentialsInSmartLock(
        StringUtils.notNullStr(username), StringUtils.notNullStr(password),
  ...
  public void onConnected(Bundle bundle) {
    ...
    case FINISH_ON_CONNECT:
      ...
      break;
    case FINISHED:
      // don't do anything special. We're reconnecting the GoogleApiClient on
      // rotation.
      break;
    }
  }
  ...
  public void showSignupToLoginMessage() {
    WPSnackbar
        .make(findViewById(R.id.main_view), R.string.signup_user_exists,
  ...
  public void onGoogleEmailSelected(String email) {
    LoginEmailFragment loginEmailFragment =
        (LoginEmailFragment)getSupportFragmentManager().findFragmentByTag(
  ...
  public void onGoogleSignupFinished(String name, String email, String photoUrl,
    ...
    if (mIsJetpackConnect) {
      ActivityLauncher.showSignupEpilogueForResult(this, name, email, photoUrl,
                                                   username, false);
    } else {
      ActivityLauncher.showMainActivityAndSignupEpilogue(this, name, email,
                                                         photoUrl, username);
    }
  ...
  public void onGoogleSignupError(String msg) {
    ...
    if (!getSupportFragmentManager().isStateSaved()) {
      ...
      dialog.initialize(
          GOOGLE_ERROR_DIALOG_TAG, getString(R.string.error), msg,
      ...
      AppLog.d(
          T.MAIN,
          "'Google sign up failed' dialog not shown, because the activity wasn't visible.");
    }
  }
  ...
  @Override
  public void gotConnectedSiteInfo(@NonNull String siteAddress,
