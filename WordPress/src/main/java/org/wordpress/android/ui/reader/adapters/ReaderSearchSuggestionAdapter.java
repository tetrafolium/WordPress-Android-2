...
public class ReaderSearchSuggestionAdapter extends CursorAdapter {
  ...
  public ReaderSearchSuggestionAdapter(Context context) {
    ...
    String clearAllText =
        context.getString(R.string.label_clear_search_history);
  ...
  public synchronized void setFilter(String filter) {
    ...
    Cursor sqlCursor =
        ReaderSearchTable.getQueryStringCursor(filter, MAX_SUGGESTIONS);
    ...
    if (sqlCursor.moveToFirst()) {
      ...
      do {
        long id = sqlCursor.getLong(
            sqlCursor.getColumnIndex(ReaderSearchTable.COL_ID));
        String query = sqlCursor.getString(
            sqlCursor.getColumnIndex(ReaderSearchTable.COL_QUERY));
  ...
  /*
   * forces setFilter() to always repopulate by skipping the isCurrentFilter()
   * check
   */
  ...
  public String getSuggestion(int position) {
    ...
    if (cursor != null) {
      return cursor.getString(
          cursor.getColumnIndex(ReaderSearchTable.COL_QUERY));
    } else {
      return null;
    }
  }
  ...
  public int getItemViewType(int position) {
    // use a different view type for the "clear" row so it doesn't get recycled
    // and used as a query row
  ...
  public View newView(Context context, Cursor cursor, ViewGroup parent) {
    View view = LayoutInflater.from(context).inflate(
        R.layout.reader_listitem_suggestion, parent, false);
  ...
  public void bindView(View view, Context context, Cursor cursor) {
    ...
    final String query =
        cursor.getString(cursor.getColumnIndex(ReaderSearchTable.COL_QUERY));
