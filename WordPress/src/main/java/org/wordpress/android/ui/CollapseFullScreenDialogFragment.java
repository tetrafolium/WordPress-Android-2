...
/**
 * A {@link DialogFragment} implementing the full-screen dialog pattern defined
 * in the <a
 * href="https://material.io/guidelines/components/dialogs.html#dialogs-full-screen-dialogs">
...
public class CollapseFullScreenDialogFragment extends DialogFragment {
  ...
  public static final String TAG =
      CollapseFullScreenDialogFragment.class.getSimpleName();
  ...
  protected static CollapseFullScreenDialogFragment
  newInstance(Builder builder) {
    CollapseFullScreenDialogFragment dialog =
        new CollapseFullScreenDialogFragment();
    dialog.setArguments(setArguments(builder));
    dialog.setContent(Fragment.instantiate(
        builder.mContext, builder.mClass.getName(), builder.mArguments));
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      mFragment = getChildFragmentManager().findFragmentById(
          R.id.full_screen_dialog_fragment_content);
    }
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    ViewGroup view = (ViewGroup)inflater.inflate(
        R.layout.collapse_full_screen_dialog_fragment, container, false);
    initToolbar(view);
  ...
  public int show(FragmentTransaction transaction, String tag) {
    ...
    transaction.setCustomAnimations(
        R.anim.full_screen_dialog_fragment_slide_up, 0, 0,
   ...
   */
  public Fragment getContent() { return this.mFragment; }
  ...
  private void initToolbar(View view) {
    Toolbar toolbar =
        view.findViewById(R.id.full_screen_dialog_fragment_toolbar);
    toolbar.setTitle(mTitle);
    toolbar.setNavigationContentDescription(R.string.description_collapse);
    toolbar.setNavigationIcon(ContextCompat.getDrawable(
        view.getContext(), R.drawable.ic_chevron_down_white_24dp));
  ...
  protected void onConfirmClicked() {
    boolean isConsumed = ((CollapseFullScreenDialogContent)mFragment)
                             .onConfirmClicked(mController);
   ...
   */
  private void setContent(Fragment fragment) { this.mFragment = fragment; }
   ...
   */
  public void setHideActivityBar(boolean hide) { this.mHideActivityBar = hide; }

  /**
   * Set callback to call when dialog is closed due to collapse click.
   *
   * @param listener {@link OnCollapseListener} interface to call on collapse
   *     click
   */
   ...
   *
   * @param listener {@link OnConfirmListener} interface to call on confirm
   *     click
   */
    ...
    if (value.type >= TypedValue.TYPE_FIRST_COLOR_INT &&
      ...
      try {
        Drawable drawable = ResourcesCompat.getDrawable(
            requireActivity().getResources(), value.resourceId,
  ...
  public static class Builder {
     ...
     */
    public Builder(@NonNull Context context) { this.mContext = context; }

    /**
     * Creates {@link CollapseFullScreenDialogFragment} with provided
     * parameters.
     *
     ...
     * @return {@link Builder} object to allow for chaining of calls to set
     *     methods
     */
    ...
    /**
     * Set {@link Fragment} to be added as dialog, which must implement {@link
     * CollapseFullScreenDialogContent}.
     *
     ...
     */
    public Builder setContent(Class<? extends Fragment> contentClass,
                              @Nullable Bundle contentArguments) {
      if (!CollapseFullScreenDialogContent.class.isAssignableFrom(
              contentClass)) {
     ...
     */
    public Builder
    setOnCollapseListener(@Nullable OnCollapseListener listener) {
      this.mOnCollapseListener = listener;
      return this;
    }
