  ...
  public static void startService(Context context, @NonNull String query,
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
      ...
      ComponentName componentName =
          new ComponentName(context, ReaderSearchJobService.class);
      ...
      JobInfo jobInfo =
          new JobInfo.Builder(JOB_READER_SEARCH_SERVICE_ID, componentName)
      ...
      if (resultCode == JobScheduler.RESULT_SUCCESS) {
        ...
        AppLog.e(AppLog.T.READER,
                 "reader search job service > job could not be scheduled");
      }
    }
  }
}
