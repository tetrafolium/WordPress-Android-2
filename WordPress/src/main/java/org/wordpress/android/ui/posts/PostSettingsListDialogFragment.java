...
public class PostSettingsListDialogFragment extends DialogFragment {
  ...
  enum DialogType { POST_STATUS, POST_FORMAT }

  interface OnPostSettingsDialogFragmentListener {
    void onPostSettingsFragmentPositiveButtonClicked(
  ...
  public static PostSettingsListDialogFragment
  newInstance(@NonNull DialogType dialogType, int index) {
    PostSettingsListDialogFragment fragment =
        new PostSettingsListDialogFragment();
  ...
  public void onAttach(Activity activity) {
    ...
    try {
      ...
      throw new ClassCastException(
          activity.toString() +
          " must implement OnPostSettingsDialogFragmentListener");
    }
  }
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    case POST_STATUS:
      ...
      builder.setSingleChoiceItems(R.array.post_settings_statuses,
                                   mCheckedIndex, clickListener);
      break;
    case POST_FORMAT:
      builder.setTitle(R.string.post_settings_post_format);
      builder.setSingleChoiceItems(R.array.post_format_display_names,
                                   mCheckedIndex, clickListener);
      break;
    }
    ...
    builder.setPositiveButton(
        android.R.string.ok, new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int which) {
            mListener.onPostSettingsFragmentPositiveButtonClicked(
                PostSettingsListDialogFragment.this);
          }
        });
  ...
  public DialogType getDialogType() { return mDialogType; }

  public int getCheckedIndex() { return mCheckedIndex; }
