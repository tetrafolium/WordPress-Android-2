...
/**
 * RecyclerView.Adapter for selecting multiple list items with simple layout
 * (TextView + divider).
 */
public class MultiSelectRecyclerViewAdapter
    extends RecyclerView.Adapter<MultiSelectRecyclerViewAdapter.ItemHolder> {
  ...
  public void onBindViewHolder(final ItemHolder holder, int position) {
    ...
    holder.mContainer.setBackgroundColor(
        isItemSelected(position) ? mSelectedColor : mUnselectedColor);
  }
  ...
  public ItemHolder onCreateViewHolder(ViewGroup parent, int type) {
    return new ItemHolder(
        LayoutInflater.from(parent.getContext())
            .inflate(R.layout.wp_simple_list_item_1, parent, false));
  }

  public String getItem(int position) { return mItems.get(position); }

  public SparseBooleanArray getItemsSelected() { return mItemsSelected; }
