...
public class ReaderEvents {
  private ReaderEvents() { throw new AssertionError(); }
  ...
  public static class TagAdded {
    ...
    public TagAdded(String tagName) { mTagName = tagName; }

    public String getTagName() { return StringUtils.notNullStr(mTagName); }
  }
  ...
  public static class UpdatePostsStarted {
    ...
    public ReaderPostServiceStarter.UpdateAction getAction() { return mAction; }
  }
  ...
  public static class UpdatePostsEnded {
    ...
    public ReaderTag getReaderTag() { return mReaderTag; }

    public ReaderActions.UpdateResult getResult() { return mResult; }
  ...
  public static class SearchPostsEnded {
    ...
    public SearchPostsEnded(@NonNull String query, int offset,
                            boolean didSucceed) {
      mQuery = query;
      mOffset = offset;
    ...
    public boolean didSucceed() { return mDidSucceed; }
  ...
  public static class RelatedPostsUpdated {
    ...
    public long getSourceSiteId() { return mSourceSiteId; }
