...
public View getView(int position, View convertView, ViewGroup parent) {
	...
	if (convertView == null) {
		convertView =
			mInflater.inflate(R.layout.reader_popup_menu_item, parent, false);
	...
	case ITEM_BLOCK:
		...
		colorRes = ContextExtensionsKt.getColorResIdFromAttribute(
			convertView.getContext(), R.attr.wpColorText);
	...
	holder.mText.setTextColor(
		convertView.getContext().getResources().getColor(colorRes));
	ColorUtils.INSTANCE.setImageResourceWithTint(holder.mIcon, iconRes,
	                                             colorRes);
