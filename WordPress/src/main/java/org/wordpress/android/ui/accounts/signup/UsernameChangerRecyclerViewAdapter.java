...
public class UsernameChangerRecyclerViewAdapter
	...
	.Adapter<UsernameChangerRecyclerViewAdapter.ViewHolder> {
...
public UsernameChangerRecyclerViewAdapter(Context context,
                                          List<String> items) {
	mContext = context;
	mItems = items;
}
...
@Override
public void
onBindViewHolder(UsernameChangerRecyclerViewAdapter.ViewHolder viewHolder,
                 int position) {
...
@Override
public UsernameChangerRecyclerViewAdapter.ViewHolder
onCreateViewHolder(ViewGroup viewGroup, int viewType) {
	final View view = LayoutInflater.from(mContext).inflate(
		R.layout.single_choice_recycler_view_item, viewGroup, false);
...
public void
setOnUsernameSelectedListener(OnUsernameSelectedListener listener) {
	mListener = listener;
}
