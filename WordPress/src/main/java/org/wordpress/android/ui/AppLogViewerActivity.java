...
public View getView(int position, View convertView, ViewGroup parent) {
	...
	if (convertView == null) {
		convertView =
			mInflater.inflate(R.layout.logviewer_listitem, parent, false);
	...
	// take the header lines (app version & device name) into account or else
	// the line numbers shown here won't match the line numbers when the log
	// is shared
...
private void shareAppLog() {
	...
	try {
		startActivity(
			Intent.createChooser(intent, getString(R.string.reader_btn_share)));
...
private void copyAppLogToClipboard() {
	try {
		...
		clipboard.setPrimaryClip(
			ClipData.newPlainText("AppLog", AppLog.toPlainText(this)));
...
public boolean onCreateOptionsMenu(Menu menu) {
	...
	MenuItem item = menu.add(Menu.NONE, ID_COPY_TO_CLIPBOARD, Menu.NONE,
