...
public class StatsConstants {
  ...
  public static final String STATS_OUTPUT_DATE_MONTH_SHORT_DAY_SHORT_FORMAT =
      "MMM d";
  public static final String STATS_OUTPUT_DATE_MONTH_LONG_DAY_SHORT_FORMAT =
      "MMMM d";
  public static final String STATS_OUTPUT_DATE_MONTH_LONG_DAY_LONG_FORMAT =
      "MMMM dd";
