...
public enum QuickStartTaskDetails {
  ...
  CUSTOMIZE_SITE_TUTORIAL(QuickStartTask.CUSTOMIZE_SITE,
  ...
  SHARE_SITE_TUTORIAL(QuickStartTask.ENABLE_POST_SHARING,
                      R.string.quick_start_list_enable_sharing_title,
                      R.string.quick_start_list_enable_sharing_subtitle,
                      R.drawable.ic_share_white_24dp),
  PUBLISH_POST_TUTORIAL(QuickStartTask.PUBLISH_POST,
  ...
  FOLLOW_SITES_TUTORIAL(QuickStartTask.FOLLOW_SITE,
  ...
  EXPLORE_PLANS(QuickStartTask.EXPLORE_PLANS,
  ...
  QuickStartTaskDetails(QuickStartTask task, int titleResId, int subtitleResId,
                        int iconResId) {
    mTask = task;
  ...
  public QuickStartTask getTask() { return mTask; }

  public int getTitleResId() { return mTitleResId; }

  public int getSubtitleResId() { return mSubtitleResId; }

  public int getIconResId() { return mIconResId; }

  public static QuickStartTaskDetails getDetailsForTask(QuickStartTask task) {
    for (QuickStartTaskDetails quickStartTaskDetails :
         QuickStartTaskDetails.values()) {
