...
public class AboutActivity
  ...
  public void onCreate(Bundle icicle) {
    ...
    version.setText(
        getString(R.string.version_with_name_param, WordPress.versionName));
    ...
    publisher.setText(getString(R.string.publisher_with_company_param,
                                getString(R.string.automattic_inc)));

    WPTextView copyright = findViewById(R.id.about_copyright);
    copyright.setText(getString(R.string.copyright_with_year_and_company_params,
