...
/*
 * adapter which shows either recommended or followed blogs - used by
 * ReaderBlogFragment
 */
public class ReaderBlogAdapter
  ...
  public interface BlogClickListener { void onBlogClicked(Object blog); }

  private final ReaderBlogType mBlogType;
  private BlogClickListener mClickListener;
  private ReaderInterfaces.DataLoadedListener mDataLoadedListener;

  private ReaderRecommendBlogList mRecommendedBlogs =
      new ReaderRecommendBlogList();
  ...
  private ReaderBlogType getBlogType() { return mBlogType; }
    ...
    case VIEW_TYPE_ITEM:
      View itemView =
          LayoutInflater.from(parent.getContext())
              .inflate(R.layout.reader_listitem_blog, parent, false);
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    if (holder instanceof BlogViewHolder) {
      ...
      case RECOMMENDED:
        ...
        mImageManager.load(blogHolder.mImgBlog, ImageType.BLAVATAR,
                           blog.getImageUrl());
        break;
      ...
      if (mClickListener != null) {
        blogHolder.itemView.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            switch (getBlogType()) {
            case RECOMMENDED:
              mClickListener.onBlogClicked(
                  mRecommendedBlogs.get(clickedPosition));
              break;
            case FOLLOWED:
  ...
  private class LoadBlogsTask extends AsyncTask<Void, Void, Boolean> {
      ...
      case FOLLOWED:
        ...
        if (hasSearchFilter()) {
          ...
          for (ReaderBlog blog : allFollowedBlogs) {
            ...
            } else if (UrlUtils.getHost(blog.getUrl())
    ...
    protected void onPostExecute(Boolean result) {
      if (result) {
        ...
        case RECOMMENDED:
          mRecommendedBlogs =
              (ReaderRecommendBlogList)mTmpRecommendedBlogs.clone();
          break;
        case FOLLOWED:
  ...
  public String getSearchFilter() { return mSearchFilter; }
  ...
  public boolean hasSearchFilter() { return !TextUtils.isEmpty(mSearchFilter); }
}
