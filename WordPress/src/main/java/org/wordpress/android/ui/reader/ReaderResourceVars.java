...
/*
 * class which holds all resource-based variables used when rendering post
 * detail
 */
...
ReaderResourceVars(Context context) {
	...
	int detailMarginWidthPx =
		resources.getDimensionPixelOffset(R.dimen.reader_detail_margin);
	...
	mGreyMediumDarkStr =
		HtmlUtils.colorResToHtmlColor(context, R.color.neutral_60);
	mGreyLightStr = HtmlUtils.colorResToHtmlColor(context, R.color.neutral_0);
	mGreyExtraLightStr =
		HtmlUtils.colorResToHtmlColor(context, R.color.neutral_0);
