...
public class BlogPreferencesActivity extends AppCompatActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (actionBar != null) {
      ...
      actionBar.setTitle(StringEscapeUtils.unescapeHtml4(
    ...
    android.app.Fragment siteSettingsFragment =
        fragmentManager.findFragmentByTag(KEY_SETTINGS_FRAGMENT);
    ...
    if (siteSettingsFragment != null) {
      if (!event.isConnected()) {
        ToastUtils.showToast(
            this, getString(R.string.site_settings_disconnected_toast),
            Duration.LONG);
      }
      ...
      // Checks for stats widgets that were synched with a blog that could be
      // gone now. StatsWidgetProvider.updateWidgetsOnLogout(this);
    }
  }
  ...
  private SiteSettingsFragment getSettingsFragment() {
    FragmentManager fragmentManager = getFragmentManager();
    return (SiteSettingsFragment)fragmentManager.findFragmentByTag(
        KEY_SETTINGS_FRAGMENT);
  }
}
