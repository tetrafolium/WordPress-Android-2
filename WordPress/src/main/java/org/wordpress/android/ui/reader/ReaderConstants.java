...
public static final int READER_MAX_USERS_TO_DISPLAY =
	500; // max # users to show in ReaderUserListActivity
public static final long READER_AUTO_UPDATE_DELAY_MINUTES =
	10; // 10 minute delay between automatic updates
public static final int READER_MAX_RECOMMENDED_TO_REQUEST =
	20; // max # of recommended blogs to request

// min width for an image to be suitable featured image
public static final int MIN_FEATURED_IMAGE_WIDTH = 640;

public static final long DISCOVER_SITE_ID =
	53424024; // site id for discover.wordpress.com

// min size for images in post content to be shown in a gallery (thumbnail
// strip) - matches the Calypso web reader
...
static final String KEY_POST_SLUGS_RESOLUTION_UNDERWAY =
	"post_slugs_resolution_underway";
...
static final String KEY_SITE_SEARCH_RESTORE_POSITION =
	"site_search_restore_position";
...
static final String KEY_ALREADY_TRACKED_GLOBAL_RELATED_POSTS =
	"already_tracked_global_related_posts";
static final String KEY_ALREADY_TRACKED_LOCAL_RELATED_POSTS =
	"already_tracked_local_related_posts";
