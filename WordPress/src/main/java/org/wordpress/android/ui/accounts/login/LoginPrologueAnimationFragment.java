...
static LoginPrologueAnimationFragment newInstance(String animationFilename,
                                                  @StringRes int promoText,
                                                  boolean lightBackground) {
	LoginPrologueAnimationFragment fragment =
		new LoginPrologueAnimationFragment();
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,
	...
	ViewGroup rootView = (ViewGroup)inflater.inflate(
		R.layout.login_intro_template_view, container, false);
...
public void onResume() {
	...
	// need to toggle the animation so the first time the fragment is resumed it
	// starts animating (if visible).
