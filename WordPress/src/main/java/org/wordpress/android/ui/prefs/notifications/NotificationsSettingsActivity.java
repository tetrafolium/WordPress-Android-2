...
public class NotificationsSettingsActivity extends AppCompatActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mMessageContainer =
        findViewById(R.id.notifications_settings_message_container);
  ...
  public void onEventMainThread(
      NotificationEvents.NotificationsSettingsStatusChanged event) {
  ...
  /**
   * Set up both primary toolbar for navigation and search, and secondary
   * toolbar for master switch.
   */
  private void setUpToolbars() {
    ...
    // Set secondary toolbar title and master switch state from shared
    // preferences.
    boolean isMasterChecked = mSharedPreferences.getBoolean(
        getString(R.string.wp_pref_notifications_master), true);
    ...
    mMasterSwitch.setOnCheckedChangeListener(
          ...
          public void onCheckedChanged(CompoundButton buttonView,
            ...
            mToolbarSwitch.setTitle(
                isChecked
                    ? getString(R.string.notification_settings_master_status_on)
                    : getString(
                          R.string.notification_settings_master_status_off));
            mSharedPreferences.edit()
                .putBoolean(getString(R.string.wp_pref_notifications_master),
                            isChecked)
                .apply();
  ...
  /**
   * Hide view when Notification Settings are disabled by toggling the master
   * switch off.
   *
   * @param isMasterChecked TRUE to hide disabled view, FALSE to show disabled
   *     view
   */
  protected void hideDisabledView(boolean isMasterChecked) {
    LinearLayout notificationsDisabledView =
        findViewById(R.id.notification_settings_disabled_view);
    notificationsDisabledView.setVisibility(isMasterChecked ? View.INVISIBLE
                                                            : View.VISIBLE);
    mFragmentContainer.setVisibility(isMasterChecked ? View.VISIBLE
                                                     : View.GONE);
  }
}
