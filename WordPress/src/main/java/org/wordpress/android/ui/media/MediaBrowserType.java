...
public enum MediaBrowserType {
  ...
  AZTEC_EDITOR_PICKER, // select multiple images or videos to insert into a
                       // post, hide source bar in portrait
  ...
  public boolean isPicker() { return this != BROWSER; }

  public boolean isBrowser() { return this == BROWSER; }
  ...
  public boolean canMultiselect() {
    return this == EDITOR_PICKER || this == AZTEC_EDITOR_PICKER ||
        this == GUTENBERG_IMAGE_PICKER || this == GUTENBERG_VIDEO_PICKER;
  }

  public boolean canFilter() { return this == BROWSER; }
