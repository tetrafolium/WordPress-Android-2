...
public class ReaderSimplePost {
  ...
  /*
     these are the specific fields we should ask for when requesting simple
     posts from the endpoint - note that we want to avoid ever requesting the
     post content, since that makes the call much heavier
  */
  ...
  public static ReaderSimplePost fromJson(JSONObject json) {
    if (json == null) {
      throw new IllegalArgumentException(
          "ReaderSimplePost requires a non-null JSONObject");
    }
  ...
  public String getSiteName() { return mSiteName; }

  public String getAuthorName() { return mAuthorName; }

  public String getAuthorAvatarUrl() { return mAuthorAvatarUrl; }

  public String getFeaturedImageUrl() { return mFeaturedImageUrl; }

  public String getRailcarJson() { return mRailcarJson; }

  public boolean isFollowing() { return mIsFollowing; }
