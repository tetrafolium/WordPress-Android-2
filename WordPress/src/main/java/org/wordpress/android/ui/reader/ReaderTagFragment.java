 ...
 */
public class ReaderTagFragment
    extends Fragment implements ReaderTagAdapter.TagDeletedListener {
  ...
  private void checkEmptyView() {
    ...
    actionableEmptyView.subtitle.setText(
        R.string.reader_empty_followed_tags_subtitle);
    actionableEmptyView.subtitle.setVisibility(View.VISIBLE);
    actionableEmptyView.setVisibility(
        hasTagAdapter() && getTagAdapter().isEmpty() ? View.VISIBLE
                                                     : View.GONE);
  }
  ...
  private ReaderTagAdapter getTagAdapter() {
    if (mTagAdapter == null) {
      ...
      mTagAdapter.setDataLoadedListener(
  ...
  private boolean hasTagAdapter() { return (mTagAdapter != null); }
