...
public class NotificationsUpdateServiceStarter {
  public static final String IS_TAPPED_ON_NOTIFICATION =
      "is-tapped-on-notification";
  ...
  public static void startService(Context context, String noteId) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
      ...
      ComponentName componentName =
          new ComponentName(context, NotificationsUpdateJobService.class);
      ...
      JobInfo jobInfo =
          new JobInfo
              .Builder(JOB_NOTIFICATIONS_UPDATE_SERVICE_ID, componentName)
      ...
      if (resultCode == JobScheduler.RESULT_SUCCESS) {
        AppLog.i(AppLog.T.READER,
                 "notifications update job service > job scheduled");
      } else {
        AppLog.e(
            AppLog.T.READER,
            "notifications update job service > job could not be scheduled");
      }
    }
  }
}
