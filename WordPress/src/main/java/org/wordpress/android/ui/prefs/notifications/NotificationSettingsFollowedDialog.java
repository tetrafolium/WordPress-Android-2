 ...
 */
public class NotificationSettingsFollowedDialog
  ...
  public static final String ARG_EMAIL_POSTS_FREQUENCY =
      "EXTRA_EMAIL_POSTS_FREQUENCY";
  public static final String ARG_NOTIFICATION_POSTS =
      "EXTRA_NOTIFICATION_POSTS";
  ...
  public static final String KEY_EMAIL_POSTS_FREQUENCY =
      "KEY_EMAIL_POSTS_FREQUENCY";
  ...
  private static final String EMAIL_POSTS_FREQUENCY_DAILY =
      SubscriptionFrequency.DAILY.toString();
  private static final String EMAIL_POSTS_FREQUENCY_INSTANTLY =
      SubscriptionFrequency.INSTANTLY.toString();
  private static final String EMAIL_POSTS_FREQUENCY_WEEKLY =
      SubscriptionFrequency.WEEKLY.toString();
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    mRadioGroupEmailPosts =
        layout.findViewById(R.id.email_new_posts_radio_group);
    mRadioButtonFrequencyInstantly =
        layout.findViewById(R.id.email_new_posts_radio_button_instantly);
    mRadioButtonFrequencyDaily =
        layout.findViewById(R.id.email_new_posts_radio_button_daily);
    mRadioButtonFrequencyWeekly =
        layout.findViewById(R.id.email_new_posts_radio_button_weekly);
    mSwitchNotificationPosts =
        layout.findViewById(R.id.notification_new_posts_switch);
    ...
    if (args != null) {
      mSwitchNotificationPosts.setChecked(
          args.getBoolean(ARG_NOTIFICATION_POSTS, false));
      mSwitchEmailPosts.setChecked(args.getBoolean(ARG_EMAIL_POSTS, false));
      mSwitchEmailComments.setChecked(
          args.getBoolean(ARG_EMAIL_COMMENTS, false));
      mRadioButtonSelected = args.getString(ARG_EMAIL_POSTS_FREQUENCY, "");

      if (mRadioButtonSelected.equalsIgnoreCase(
              EMAIL_POSTS_FREQUENCY_INSTANTLY)) {
        mRadioButtonFrequencyInstantly.setChecked(true);
      } else if (mRadioButtonSelected.equalsIgnoreCase(
                     EMAIL_POSTS_FREQUENCY_DAILY)) {
        mRadioButtonFrequencyDaily.setChecked(true);
      } else if (mRadioButtonSelected.equalsIgnoreCase(
                     EMAIL_POSTS_FREQUENCY_WEEKLY)) {
    ...
    builder.setTitle(
        getString(R.string.notification_settings_followed_dialog_title));
  ...
  public void onDismiss(DialogInterface dialog) {
    ...
    if (target != null) {
      target.onActivityResult(getTargetRequestCode(), Activity.RESULT_OK,
                              getResultIntent());
    }
  ...
  private Intent getResultIntent() {
    if (mConfirmed) {
      ...
      intent.putExtra(KEY_NOTIFICATION_POSTS,
                      mSwitchNotificationPosts.isChecked());
  ...
  private void toggleEmailFrequencyButtons(boolean enabled) {
    ...
    if (enabled && mRadioButtonSelected != null &&
        mRadioButtonSelected.equalsIgnoreCase("")) {
      mRadioButtonFrequencyInstantly.setChecked(true);
    }
  }
}
