...
/**
 * A block that displays information about a User (such as a user that liked a
 * post)
 */
public class UserNoteBlock extends NoteBlock {
  ...
  public interface OnGravatarClickedListener {
    // userId is currently unused, but will be handy once a profile view is
    // added to the app
  ...
  public UserNoteBlock(
    ...
    super(noteObject, imageManager, notificationsUtilsWrapper,
  ...
  void setAvatarSize(int size) { mAvatarSz = size; }

  int getAvatarSize() { return mAvatarSz; }
  ...
  public View configureView(View view) {
    final UserActionNoteBlockHolder noteBlockHolder =
        (UserActionNoteBlockHolder)view.getTag();
  ...
  private boolean hasUserUrl() { return !TextUtils.isEmpty(getUserUrl()); }
  ...
  protected void showBlogPreview() {
    ...
    if (mGravatarClickedListener != null) {
      mGravatarClickedListener.onGravatarClicked(
          FormattableContentUtilsKt.getMetaIdsSiteIdOrZero(getNoteData()),
          FormattableContentUtilsKt.getMetaIdsUserIdOrZero(getNoteData()),
          siteUrl);
    }
  }
}
