...
public class PublicizeAccountChooserListAdapter
	...
	.Adapter<PublicizeAccountChooserListAdapter.ViewHolder> {
...
public PublicizeAccountChooserListAdapter(
	Context context, List<PublicizeConnection> connectionItems,
...
public void onBindViewHolder(final ViewHolder holder, int position) {
	...
	mImageManager.load(holder.mProfileImageView, ImageType.PHOTO,
