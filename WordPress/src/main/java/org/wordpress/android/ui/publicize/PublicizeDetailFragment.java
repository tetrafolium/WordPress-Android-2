...
public static PublicizeDetailFragment
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,
	...
	ViewGroup rootView = (ViewGroup)inflater.inflate(
		R.layout.publicize_detail_fragment, container, false);
	...
	mConnectBtn =
		(ConnectButton)mServiceCardView.findViewById(R.id.button_connect);
...
public void loadData() {
	...
	if (isGooglePlus()) {
		...
		String serviceLabel = String.format(
			getString(R.string.connection_service_label), mService.getLabel());
		TextView txtService =
			(TextView)mServiceCardView.findViewById(R.id.text_service);
		txtService.setText(serviceLabel);

		String description =
			String.format(getString(R.string.connection_service_description),
			              mService.getLabel());
		TextView txtDescription =
			(TextView)mServiceCardView.findViewById(R.id.text_description);
...
private void showFacebookWarning() {
	...
	TextView txtNotice =
		(TextView)mServiceCardView.findViewById(R.id.text_description_notice);
	txtNotice.setText(noticeText);
	txtNotice.setVisibility(View.VISIBLE);

	TextView learnMoreButton =
		(TextView)mServiceCardView.findViewById(R.id.learn_more_button);
...
private PublicizeActions.OnPublicizeActionListener
getOnPublicizeActionListener() {
