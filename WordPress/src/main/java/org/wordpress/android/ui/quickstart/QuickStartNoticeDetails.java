...
public enum QuickStartNoticeDetails {
  ...
  QuickStartNoticeDetails(QuickStartTask task, int titleResId,
                          int messageResId) {
    mTask = task;
  ...
  public int getMessageResId() { return mMessageResId; }

  public static QuickStartNoticeDetails getNoticeForTask(QuickStartTask task) {
    for (QuickStartNoticeDetails quickStartTaskDetails :
         QuickStartNoticeDetails.values()) {
