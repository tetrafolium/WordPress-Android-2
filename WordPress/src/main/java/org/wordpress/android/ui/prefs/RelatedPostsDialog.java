...
public class RelatedPostsDialog
    extends DialogFragment implements DialogInterface.OnClickListener,
                                      CompoundButton.OnCheckedChangeListener {
  /**
   * boolean
   * <p>
   * Sets the default state of the Show Related Posts switch. The switch is off
   * by default.
   */
   ...
   * boolean
   * <p>
   * Sets the default state of the Show Headers checkbox. The checkbox is off by
   * default.
   */
   ...
   * boolean
   * <p>
   * Sets the default state of the Show Images checkbox. The checkbox is off by
   * default.
   */
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    // noinspection InflateParams
    View titleView =
        inflater.inflate(R.layout.detail_list_preference_title, null);
