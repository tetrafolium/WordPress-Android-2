...
private static OkHttpClient createClient(final String accessToken) {
	...
	// httpClientBuilder.addInterceptor(new
	...
	return new Request.Builder()
	       ...
	       .post(new MultipartBody.Builder()
	             ...
	             .addFormDataPart("filedata", file.getName(),
	                              new StreamingRequest(file))
	             .build())
	       .build();
}

public static void
uploadGravatar(final File file, final String email, final String accessToken,
	...
	createClient(accessToken).newCall(request).enqueue(new Callback() {
			...
			throws IOException {
			        if (!response.isSuccessful()) {
			                ...
			                // response's body can only be read once so, keep it in a local
			                // variable
			                String responseBody;
						...
						AnalyticsTracker.Stat.ME_GRAVATAR_UPLOAD_UNSUCCESSFUL,
						properties);
			                AppLog.w(AppLog.T.API,
			                         "Network call unsuccessful trying to upload Gravatar: " +
			                         responseBody);
				}
			...
			public void onFailure(okhttp3.Call call, final IOException e) {
					...
					e != null ? e.getClass().getCanonicalName() : "null";
			        String exceptionMessage = e != null ? e.getMessage() : "null";

			        AppLog.w(AppLog.T.API,
			                 "Network call failure trying to upload Gravatar!" +
			                 exceptionMessage);
			        ...
			        if (!(e instanceof java.net.UnknownHostException)) {
			                ...
			                AnalyticsTracker.track(
						AnalyticsTracker.Stat.ME_GRAVATAR_UPLOAD_EXCEPTION, properties);
