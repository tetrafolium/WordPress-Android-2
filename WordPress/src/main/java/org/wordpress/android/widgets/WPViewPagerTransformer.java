...
/*
 * ViewPager transformation animation invoked when a visible/attached page is
 * scrolled - before changing this, first see
 * https://code.google.com/p/android/issues/detail?id=58918#c5 tl;dr make sure
 * to remove X translation when a page is no longer fully visible
 *
