...
/**
 * {@link Snackbar} with custom colors and layout mimicking the updated design
 * pattern defined in the Material Design guidelines <a
 * href="https://material.io/design/components/snackbars.html#spec">specifications</a>.
 * The views include message and action button.  Any empty or null view is
...
public class WPSnackbar {
  ...
  private WPSnackbar(@NonNull View view, @NonNull CharSequence text,
                     int duration) {
    ...
    mContentView =
        LayoutInflater.from(context).inflate(R.layout.snackbar, null);
  ...
  public static WPSnackbar make(@NonNull View view, @NonNull CharSequence text,
                                int duration) {
    return new WPSnackbar(view, text, duration);
  }

  public static WPSnackbar make(@NonNull View view, @StringRes int textRes,
                                int duration) {
  ...
  public WPSnackbar setAction(CharSequence text,
                              View.OnClickListener listener) {
    setButtonTextAndVisibility((Button)mContentView.findViewById(R.id.action),
                               text, listener);
    return this;
  }

  public WPSnackbar setAction(@StringRes int textRes,
                              View.OnClickListener listener) {
