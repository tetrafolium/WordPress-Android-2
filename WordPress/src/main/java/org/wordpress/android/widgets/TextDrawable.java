...
public class TextDrawable extends Drawable {
  ...
  public TextDrawable(Context context) {
    ...
    setTextColor(textColor != null ? textColor
  ...
  public void setText(int text) { this.setText(String.valueOf(text)); }
  ...
  public void setTextSize(int unit, float size) {
    float dimension =
        TypedValue.applyDimension(unit, size, mResources.getDisplayMetrics());
   ...
   */
  public Layout.Alignment getTextAlign() { return mTextAlignment; }
   ...
   * @param color Color value such as {@link Color#WHITE} or {@link
   ...
   * @param colorStateList ColorStateList of text colors, such as inflated from
   *     an R.color resource
   */
