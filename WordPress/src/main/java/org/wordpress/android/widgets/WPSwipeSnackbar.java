...
/*
 * Snackbar used with a ViewPager to indicate to the user they can swipe to see
 * more pages
 */
public class WPSwipeSnackbar {
  public enum SwipeArrows { LEFT, RIGHT, BOTH, NONE }

  private WPSwipeSnackbar() { throw new AssertionError(); }
  ...
  private static Snackbar show(@NonNull ViewPager viewPager,
                               @NonNull SwipeArrows arrows) {
    Context context = viewPager.getContext();
    String swipeText =
        context.getResources().getString(R.string.swipe_for_more);
    String arrowLeft =
        context.getResources().getString(R.string.previous_button);
    ...
    Snackbar snackbar = Snackbar.make(
        viewPager, text, Snackbar.LENGTH_LONG); // CHECKSTYLE IGNORE
