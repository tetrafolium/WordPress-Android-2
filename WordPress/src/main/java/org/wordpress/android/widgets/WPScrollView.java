...
/**
 * ScrollView which reports when user has scrolled up or down, and when
...
public class WPScrollView extends ScrollView {
  ...
  public WPScrollView(Context context) { this(context, null); }
  ...
  public boolean canScrollUp() { return canScrollVertically(-1); }

  public boolean canScrollDown() { return canScrollVertically(1); }
}
