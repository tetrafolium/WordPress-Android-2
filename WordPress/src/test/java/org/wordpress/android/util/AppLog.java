 ...
 *
 * Testing version:
 * - replaces Log calls with System.out, since the unit tests don't have access
...
public class AppLog {
   ...
   *                It usually identifies the class or activity where the log
   * call occurs.
  ...
  public static void e(T tag, Throwable tr) {
    System.out.println("e - " + TAG + " - " + tag.toString() + " - " +
                       tr.getMessage());
  }
  ...
  public enum LogLevel { v, d, i, w, e }
}
