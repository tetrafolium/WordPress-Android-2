...
public void enterEmail(String email,
                       ActivityTestRule<LoginMagicLinkInterceptActivity>
...
public void checkEpilogue(String displayName, String username) {
	// Check Epilogue data
	ViewInteraction emailHeaderView =
		onView(withId(R.id.signup_epilogue_header_email));
	waitForElementToBeDisplayed(emailHeaderView);

	ViewInteraction displayNameField =
		onView(allOf(withId(R.id.input), withText(displayName)));
	ViewInteraction usernameField =
		onView(allOf(withId(R.id.input), withText(username)));
...
public void enterPassword(String password) {
	...
	ViewInteraction passwordField =
		onView(allOf(withId(R.id.input), withHint("Password (optional)")));
