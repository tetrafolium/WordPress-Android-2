...
public class RestClientCustomizableMock extends RestClient {
  ...
  public String getAbsoluteURL(String url) { return null; }
  ...
  public RestRequest post(String path, java.util.Map<String, String> body,
  ...
  private VolleyError forgeVolleyErrorFromFilename(String filename) {
    ...
    NetworkResponse networkResponse =
        new NetworkResponse(400, data, null, false);
  ...
  public RestRequest makeRequest(int method, String url,
                                 java.util.Map<String, String> params,
                                 RestRequest.Listener listener,
                                 RestRequest.ErrorListener errorListener) {
    AppLog.v(T.TESTS, this.getClass() + ": makeRequest(" + url + ")");
    RestRequest dummyReturnValue =
        new RestRequest(method, url, params, listener, errorListener);
  ...
  public RestRequest send(RestRequest request) { return request; }
