...
public void testGravatarUploadRequest() throws IOException {
	...
	File tempFile = new File(
		getInstrumentation().getTargetContext().getCacheDir(), "tempFile.jpg");
	...
	assertTrue(
		requestBody.contentType().toString().startsWith("multipart/form-data"));
	...
	assertTrue(
		body.contains("Content-Disposition: form-data; name=\"account\""));
