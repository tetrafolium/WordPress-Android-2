...
public class AutolinkUtilsTest extends InstrumentationTestCase {
  ...
  public void testNullString() { AutolinkUtils.autoCreateLinks(null); }
  ...
  public void testBlacklistedUrlKickStarter1() {
    String sourceTest =
        "testing https://www.kickstarter.com/projects/583173617/raspi-boy-retro-"
  ...
  public void testMixedUrls1() {
    String sourceTest =
        "hey http://youtube.com/watch?test salut http://test.com hello";
    String output = AutolinkUtils.autoCreateLinks(sourceTest);
    String expected =
  ...
  public void testMixedUrls2() {
    String sourceTest =
        "http://test.com http://www.youtube.com/watch?test http://test.com http://youtu.be/wat";
    String output = AutolinkUtils.autoCreateLinks(sourceTest);
    String expected =
        "<a href=\"http://test.com\">http://test.com</a> http://www.youtube.com/watch?test "
