...
private static final String WPCOM_ADDRESS_1 =
	"http://wordpress.com/xmlrpc.php";
private static final String WPCOM_ADDRESS_2 =
	"http://wordpress.com#.b.com/test";
private static final String WPCOM_ADDRESS_3 =
	"http://wordpress.com/xmlrpc.php";
private static final String WPCOM_ADDRESS_4 = "https://wordpress.com";
private static final String WPCOM_ADDRESS_5 =
	"https://wordpress.com/test#test";
private static final String WPCOM_ADDRESS_6 =
...
private static final String NOT_WPCOM_ADDRESS_3 =
	"https://thisisnotwordpress.com";
...
public void testSafeToAddAuthToken8() {
	// Not HTTPS
	assertFalse(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURL(WPCOM_ADDRESS_1)));
}

public void testSafeToAddAuthToken9() {
	// Not HTTPS
	assertFalse(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURL(WPCOM_ADDRESS_2)));
}

public void testSafeToAddAuthToken10() {
	// Not HTTPS
	assertFalse(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURL(WPCOM_ADDRESS_3)));
}

public void testSafeToAddAuthToken11() {
	assertTrue(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURL(WPCOM_ADDRESS_4)));
}

public void testSafeToAddAuthToken12() {
	assertTrue(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURL(WPCOM_ADDRESS_5)));
}

public void testSafeToAddAuthToken13() {
	// Not wpcom
	assertFalse(WPUrlUtils.safeToAddWordPressComAuthToken(
			    buildURL(NOT_WPCOM_ADDRESS_1)));
}

public void testSafeToAddAuthToken14() {
	// Not wpcom
	assertFalse(WPUrlUtils.safeToAddWordPressComAuthToken(
			    buildURL(NOT_WPCOM_ADDRESS_2)));
}

public void testSafeToAddAuthToken15() {
	// Not HTTPS
	assertFalse(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURI(WPCOM_ADDRESS_1)));
}

public void testSafeToAddAuthToken16() {
	// Not HTTPS
	assertFalse(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURI(WPCOM_ADDRESS_2)));
}

public void testSafeToAddAuthToken17() {
	// Not HTTPS
	assertFalse(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURI(WPCOM_ADDRESS_3)));
}

public void testSafeToAddAuthToken18() {
	assertTrue(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURI(WPCOM_ADDRESS_4)));
}

public void testSafeToAddAuthToken19() {
	assertTrue(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURI(WPCOM_ADDRESS_5)));
}

public void testSafeToAddAuthToken20() {
	// Not wpcom
	assertFalse(WPUrlUtils.safeToAddWordPressComAuthToken(
			    buildURI(NOT_WPCOM_ADDRESS_1)));
}

public void testSafeToAddAuthToken21() {
	// Not wpcom
	assertFalse(WPUrlUtils.safeToAddWordPressComAuthToken(
			    buildURI(NOT_WPCOM_ADDRESS_2)));
}
...
public void testSafeToAddAuthToken23() {
	// Not wpcom
	assertFalse(WPUrlUtils.safeToAddWordPressComAuthToken(
			    buildURL(NOT_WPCOM_ADDRESS_3)));
}

public void testSafeToAddAuthToken24() {
	// Not wpcom
	assertFalse(WPUrlUtils.safeToAddWordPressComAuthToken(
			    buildURI(NOT_WPCOM_ADDRESS_3)));
}
...
public void testSafeToAddAuthToken26() {
	assertTrue(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURL(WPCOM_ADDRESS_6)));
}

public void testSafeToAddAuthToken27() {
	assertTrue(
		WPUrlUtils.safeToAddWordPressComAuthToken(buildURI(WPCOM_ADDRESS_6)));
}
