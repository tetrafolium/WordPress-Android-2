...
public class NotesParseTest extends TestCase {
  ...
  // Trying to reproduce
  // https://github.com/wordpress-mobile/WordPress-Android/issues/900
  ...
  public void testSpanInListItemFullTest() {
    String text =
        "<p>Au Mercredi 18 septembre 2013 vous avez pulvérisé votre précédent record de follows "
        +
    ...
    Spanned spanned = HtmlUtils.fromHtml(text);
    assertTrue(
        spanned.toString().contains("Current Record: 20\nOld Record: 1\n"));
  }
}
